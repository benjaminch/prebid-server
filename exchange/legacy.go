...
func (bidder *adaptedAdapter) requestBid(ctx context.Context, request *openrtb.BidRequest, name openrtb_ext.BidderName, bidAdjustment float64, rateConverter *currencies.RateConverter) (*pbsOrtbSeatBid, []error) {
